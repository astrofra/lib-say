...
static const phoneme_def_t g_phonemes[PH_COUNT] = {
    ...
    { PH_LX,    "LX",    0, 1, LIQ,  40.0,  76.0, 0.70, 0.04, { 350, 1100, 2400, 3300, 4200 }, { 110, 130, 180, 220, 280 }, { 0.72, 0.56, 0.18, 0.07, 0.03 } }, /* dark L — F2 lowered to 1100 */
    { PH_RX,    "RX",    0, 1, LIQ,  35.0,  68.0, 0.70, 0.08, { 320, 1300, 1700, 2500, 3400 }, { 120, 150, 200, 250, 310 }, { 0.72, 0.54, 0.18, 0.07, 0.03 } }, /* alternate R — slightly different F3 */
    { PH_AXP,   "AXP",   1, 1, VOW,  25.0,  50.0, 0.74, 0.04, { 500, 1500, 2500, 3400, 4300 }, { 110, 130, 170, 220, 270 }, { 0.78, 0.66, 0.24, 0.10, 0.05 } }, /* paragogic schwa — short, lower amplitude */
    { PH_IX,    "IX",    1, 1, VOW,  35.0,  72.0, 0.85, 0.02, { 380, 1900, 2700, 3500, 4400 }, { 80, 100, 130, 185, 240 }, { 0.85, 0.72, 0.28, 0.12, 0.05 } } /* reduced ɪ — shorter, slightly more centralised */
};
