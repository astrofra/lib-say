...
typedef struct phoneme_def_t {
    ...
    int is_vowel;
    int voiced;
    double min_ms;   /* B1 — floor duration. Cascading percentage rules act on (base_ms - min_ms);
                      * the floor is preserved so aggressive shortening can't crush a phoneme below
                      * intelligibility. Models the Amiga PROSOD MINDUR / INHDUR two-tier scheme. */
    double base_ms;  /* Inherent (baseline) duration. Equivalent to Amiga INHDUR. */
    double amplitude;
    double noise_mix;
...
static const phoneme_def_t g_phonemes[PH_COUNT] = {
    /* { id, sym, vowel, voiced, MIN, INH, amp, noise, F-freq[5], BW[5], gain[5] } */
    { PH_PAUSE, "PAUSE", 0, 0, 50.0,  90.0, 0.00, 0.00, { 0 }, { 0 }, { 0 } },
    { PH_A,     "A",     1, 1, 60.0, 115.0, 1.00, 0.02, { 800, 1200, 2800, 3600, 4500 }, { 90, 100, 150, 200, 260 }, { 1.00, 0.85, 0.35, 0.16, 0.08 } },
    { PH_AE,    "AE",    1, 1, 60.0, 110.0, 1.00, 0.02, { 700, 1700, 2500, 3600, 4500 }, { 90, 110, 150, 200, 260 }, { 1.00, 0.82, 0.34, 0.15, 0.07 } },
    { PH_AH,    "AH",    1, 1, 55.0, 105.0, 0.96, 0.03, { 650, 1200, 2500, 3400, 4400 }, { 100, 120, 160, 200, 260 }, { 0.98, 0.78, 0.30, 0.14, 0.07 } },
    { PH_E,     "E",     1, 1, 58.0, 108.0, 0.98, 0.02, { 500, 1900, 2600, 3400, 4300 }, { 90, 100, 130, 180, 240 }, { 0.98, 0.84, 0.34, 0.14, 0.07 } },
    { PH_EH,    "EH",    1, 1, 56.0, 104.0, 0.98, 0.02, { 600, 1700, 2500, 3400, 4300 }, { 95, 105, 135, 185, 240 }, { 0.98, 0.83, 0.34, 0.15, 0.07 } },
    { PH_I,     "I",     1, 1, 58.0, 108.0, 0.98, 0.02, { 300, 2200, 3000, 3800, 4700 }, { 70, 95, 120, 180, 240 }, { 0.96, 0.82, 0.32, 0.14, 0.06 } },
    { PH_IH,    "IH",    1, 1, 52.0,  96.0, 0.92, 0.02, { 400, 2000, 2800, 3600, 4500 }, { 80, 100, 130, 185, 240 }, { 0.92, 0.78, 0.30, 0.13, 0.06 } },
    { PH_O,     "O",     1, 1, 60.0, 110.0, 1.00, 0.02, { 450,  900, 2400, 3400, 4300 }, { 90, 100, 140, 200, 240 }, { 1.00, 0.84, 0.34, 0.14, 0.06 } },
    { PH_OH,    "OH",    1, 1, 58.0, 108.0, 0.98, 0.02, { 550,  900, 2400, 3400, 4300 }, { 95, 105, 145, 200, 240 }, { 0.98, 0.84, 0.34, 0.14, 0.06 } },
    { PH_U,     "U",     1, 1, 60.0, 112.0, 0.96, 0.02, { 350,  800, 2200, 3200, 4200 }, { 70, 95, 130, 190, 240 }, { 0.96, 0.80, 0.30, 0.13, 0.06 } },
    { PH_Y,     "Y",     1, 1, 58.0, 110.0, 0.96, 0.02, { 320, 1750, 2400, 3300, 4200 }, { 75, 100, 130, 180, 240 }, { 0.96, 0.80, 0.30, 0.13, 0.06 } },
    { PH_EU,    "EU",    1, 1, 56.0, 106.0, 0.95, 0.02, { 400, 1500, 2400, 3300, 4200 }, { 80, 100, 130, 180, 240 }, { 0.95, 0.80, 0.30, 0.13, 0.06 } },
    { PH_SCHWA, "SCHWA", 1, 1, 30.0,  85.0, 0.88, 0.03, { 500, 1500, 2500, 3400, 4300 }, { 100, 120, 160, 210, 260 }, { 0.88, 0.74, 0.28, 0.12, 0.06 } },
    { PH_AN,    "AN",    1, 1, 65.0, 118.0, 0.96, 0.04, { 650, 1100, 2300, 3200, 4100 }, { 110, 130, 170, 210, 260 }, { 0.94, 0.76, 0.30, 0.12, 0.06 } },
    { PH_ON,    "ON",    1, 1, 65.0, 116.0, 0.96, 0.04, { 500,  900, 2200, 3200, 4100 }, { 110, 130, 170, 210, 260 }, { 0.94, 0.76, 0.30, 0.12, 0.06 } },
    { PH_IN,    "IN",    1, 1, 62.0, 114.0, 0.95, 0.04, { 450, 1800, 2500, 3400, 4300 }, { 110, 125, 160, 210, 260 }, { 0.94, 0.80, 0.30, 0.12, 0.06 } },
    { PH_W,     "W",     0, 1, 38.0,  72.0, 0.70, 0.03, { 320,  800, 2200, 3000, 3900 }, { 110, 130, 180, 220, 280 }, { 0.72, 0.56, 0.18, 0.07, 0.03 } },
    { PH_J,     "J",     0, 1, 36.0,  68.0, 0.68, 0.04, { 320, 2100, 2900, 3600, 4400 }, { 110, 130, 180, 220, 280 }, { 0.70, 0.58, 0.18, 0.07, 0.03 } },
    { PH_R,     "R",     0, 1, 40.0,  76.0, 0.72, 0.08, { 300, 1300, 1800, 2600, 3500 }, { 110, 140, 190, 240, 300 }, { 0.74, 0.56, 0.20, 0.08, 0.03 } },
    { PH_L,     "L",     0, 1, 40.0,  76.0, 0.70, 0.04, { 350, 1500, 2600, 3400, 4300 }, { 110, 130, 180, 220, 280 }, { 0.72, 0.56, 0.18, 0.07, 0.03 } },
    { PH_M,     "M",     0, 1, 42.0,  78.0, 0.72, 0.05, { 250, 1200, 2100, 2900, 3800 }, { 130, 150, 200, 240, 300 }, { 0.74, 0.54, 0.18, 0.07, 0.03 } },
    { PH_N,     "N",     0, 1, 40.0,  76.0, 0.72, 0.05, { 300, 1500, 2500, 3400, 4300 }, { 130, 150, 200, 240, 300 }, { 0.74, 0.54, 0.18, 0.07, 0.03 } },
    { PH_NY,    "NY",    0, 1, 42.0,  78.0, 0.72, 0.06, { 300, 1800, 2600, 3500, 4300 }, { 130, 150, 200, 240, 300 }, { 0.74, 0.54, 0.18, 0.07, 0.03 } },
    { PH_NG,    "NG",    0, 1, 42.0,  78.0, 0.72, 0.06, { 300, 1400, 2200, 3000, 3800 }, { 130, 150, 200, 240, 300 }, { 0.74, 0.54, 0.18, 0.07, 0.03 } },
    { PH_P,     "P",     0, 0, 42.0,  68.0, 0.62, 1.00, { 500, 1400, 2400, 3500, 4500 }, { 300, 340, 380, 420, 500 }, { 0.40, 0.28, 0.24, 0.20, 0.14 } },
    { PH_B,     "B",     0, 1, 44.0,  70.0, 0.64, 0.36, { 500, 1400, 2400, 3500, 4500 }, { 300, 340, 380, 420, 500 }, { 0.42, 0.30, 0.24, 0.20, 0.14 } },
    { PH_T,     "T",     0, 0, 40.0,  66.0, 0.62, 1.00, { 600, 1700, 2800, 3800, 4800 }, { 280, 330, 380, 420, 500 }, { 0.40, 0.28, 0.24, 0.20, 0.14 } },
    { PH_D,     "D",     0, 1, 42.0,  68.0, 0.64, 0.34, { 600, 1700, 2800, 3800, 4800 }, { 280, 330, 380, 420, 500 }, { 0.42, 0.30, 0.24, 0.20, 0.14 } },
    { PH_K,     "K",     0, 0, 44.0,  70.0, 0.62, 1.00, { 700, 1800, 3000, 3900, 4900 }, { 280, 330, 380, 420, 500 }, { 0.40, 0.28, 0.24, 0.20, 0.14 } },
    { PH_G,     "G",     0, 1, 46.0,  72.0, 0.64, 0.36, { 700, 1800, 3000, 3900, 4900 }, { 280, 330, 380, 420, 500 }, { 0.42, 0.30, 0.24, 0.20, 0.14 } },
    { PH_F,     "F",     0, 0, 44.0,  82.0, 0.66, 1.00, { 900, 1800, 2900, 3900, 5000 }, { 250, 290, 340, 390, 450 }, { 0.42, 0.34, 0.28, 0.22, 0.16 } },
    { PH_V,     "V",     0, 1, 44.0,  84.0, 0.68, 0.18, { 900, 1800, 2900, 3900, 5000 }, { 250, 290, 340, 390, 450 }, { 0.44, 0.34, 0.28, 0.22, 0.16 } },
    { PH_S,     "S",     0, 0, 48.0,  92.0, 0.60, 1.00, { 1200, 2800, 4200, 5400, 6700 }, { 230, 300, 380, 470, 560 }, { 0.24, 0.32, 0.48, 0.52, 0.34 } },
    { PH_Z,     "Z",     0, 1, 48.0,  90.0, 0.60, 0.44, { 1200, 2800, 4200, 5400, 6700 }, { 230, 300, 380, 470, 560 }, { 0.26, 0.32, 0.46, 0.48, 0.30 } },
    { PH_SH,    "SH",    0, 0, 50.0,  94.0, 0.62, 1.00, { 1050, 2400, 3500, 4650, 5900 }, { 230, 300, 380, 470, 560 }, { 0.24, 0.42, 0.54, 0.44, 0.26 } },
    { PH_ZH,    "ZH",    0, 1, 48.0,  92.0, 0.62, 0.44, { 1050, 2400, 3500, 4650, 5900 }, { 230, 300, 380, 470, 560 }, { 0.26, 0.40, 0.50, 0.40, 0.24 } },
    { PH_H,     "H",     0, 0, 36.0,  68.0, 0.48, 0.68, { 1000, 1700, 2600, 3500, 4400 }, { 260, 310, 360, 410, 470 }, { 0.34, 0.26, 0.20, 0.16, 0.12 } },
    { PH_TH,    "TH",    0, 0, 48.0,  90.0, 0.72, 1.00, { 900, 2000, 3800, 6000, 8000 }, { 280, 360, 460, 580, 700 }, { 0.12, 0.22, 0.32, 0.46, 0.62 } },
    { PH_DH,    "DH",    0, 1, 48.0,  90.0, 0.60, 0.44, { 950, 2200, 3300, 4400, 5600 }, { 250, 320, 400, 500, 620 }, { 0.30, 0.34, 0.34, 0.28, 0.16 } },
    { PH_CH,    "CH",    0, 0, 52.0,  92.0, 0.68, 1.00, { 1300, 2600, 3700, 4800, 5900 }, { 220, 270, 320, 370, 420 }, { 0.20, 0.36, 0.54, 0.42, 0.24 } },
    { PH_JH,    "JH",    0, 1, 52.0,  92.0, 0.70, 0.48, { 1300, 2600, 3700, 4800, 5900 }, { 220, 270, 320, 370, 420 }, { 0.22, 0.34, 0.52, 0.40, 0.22 } },
    { PH_TS,    "TS",    0, 0, 50.0,  90.0, 0.66, 1.00, { 1200, 2500, 3600, 4700, 5800 }, { 220, 270, 320, 370, 420 }, { 0.46, 0.38, 0.30, 0.24, 0.18 } },
    { PH_DZ,    "DZ",    0, 1, 50.0,  90.0, 0.68, 0.48, { 1200, 2500, 3600, 4700, 5800 }, { 220, 270, 320, 370, 420 }, { 0.48, 0.38, 0.30, 0.24, 0.18 } }
};
...
static int say_find_prev_non_pause(const segment_t *segments, size_t end_index)
{
    size_t i;
...
static int say_is_voiced_fricative_phone(phoneme_id_t id)
{
    return id == PH_V || id == PH_Z || id == PH_ZH || id == PH_DH;
}

static int say_is_voiced_plosive_phone(phoneme_id_t id)
{
    return id == PH_B || id == PH_D || id == PH_G;
}

static int say_is_voiceless_plosive_phone(phoneme_id_t id)
{
    return id == PH_P || id == PH_T || id == PH_K;
}
...
)
{
    ...
    for (i = 0; i < segment_count; ++i) {
        ...
        /* B2 — Amiga PROSOD Rule 13: /S/+plosive cluster lengthens the sibilant.
        ...
        if (options->language == SAY_LANG_EN && say_is_sibilant_phone(segments[i].phoneme) &&
            ...
            duration_ms *= 1.40;  /* Amiga uses 1.75; scaled down because lib-say's sibilant
                                   * base_ms is already higher than the Amiga's INHDUR. */
        }

        /* B2 — Amiga PROSOD Rule 14: plosive after /S/ shortened.
        ...
        /* B2 — Amiga PROSOD Rule 9: vowel before voiced fricative is lengthened.
        ...
        if (options->language == SAY_LANG_EN && say_is_vowel_phone(segments[i].phoneme) &&
            ...
            duration_ms *= 1.30;  /* Amiga uses 1.60; scaled down to avoid stacking with
                                   * the existing word-final fricative bumps. */
        }

        /* B1 — two-tier duration formula (Amiga PROSOD final step).
         *
         ...
         * mirroring the Amiga MINDUR/INHDUR scheme. The floor is halved for
         * unstressed vowels (Amiga Rule 7) so weak vowels can compress further. */
        {
        ...
        /* B2 — Amiga PROSOD Rule 11: a sonorant after a voiceless plosive gets +25 ms.
